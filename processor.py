...
class Semeval_NLI_M_Processor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        ...
        train_data = train_data.drop(train_data[train_data[1] == "none"].sample(frac=.70,random_state=0).index)
    ...
    def get_dev_examples(self, data_dir):
       ...
       # dev_data=dev_data.drop(dev_data[dev_data[1].eq("none")].sample(n).index)
        ...
        dev_data = dev_data.drop(dev_data[dev_data[1] == "none"].sample(frac=.70,random_state=0).index)
    ...
    def get_test_examples(self, data_dir):
        ...
        test_data = test_data.drop(test_data[test_data[1] == "none"].sample(frac=.70,random_state=0).index)
